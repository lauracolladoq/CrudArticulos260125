...
import com.example.crudarticulos260125.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun login() {
        ...
        // Evitar login automático si se ha cerrado sesión
    ...
    override fun onStart() {
        // Salta el login si ya está logueado
        super.onStart()
